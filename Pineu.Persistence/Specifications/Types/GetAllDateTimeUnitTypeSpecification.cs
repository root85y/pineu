...
internal sealed class GetAllDateTimeUnitTypeSpecification : Specification<DateTimeUnitType> {
    public GetAllDateTimeUnitTypeSpecification(IEnumerable<short>? ids, string? search) {
