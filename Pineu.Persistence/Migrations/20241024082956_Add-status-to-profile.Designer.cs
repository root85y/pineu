...
namespace Pineu.Persistence.Migrations
{
    ...
    [Migration("20241024082956_Add-status-to-profile")]
            ...
            modelBuilder.Entity("Pineu.Domain.Entities.SystemFiles.SystemFile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 10, 24, 11, 59, 56, 48, DateTimeKind.Local).AddTicks(5723),
                            FilePath = "",
                            UpdatedAt = new DateTime(2024, 10, 24, 11, 59, 56, 48, DateTimeKind.Local).AddTicks(5731),
                            Url = ""
                        });
                });
            ...
            modelBuilder.Entity("Pineu.Persistence.AuthEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ea18b6da-8710-4026-bf54-701ba6464431",
                            CreatedAt = new DateTime(2024, 10, 24, 11, 59, 55, 965, DateTimeKind.Local).AddTicks(4999),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBMRXXDmkm+KnEajwJPmlORIgQHx6TpXwQDso1LR24k3jdzbcHWEjqnIYpYx7bAhCA==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "a7e13eaa-a912-4409-80df-edbe8e6205f6",
                            TwoFactorEnabled = false,
                            UpdatedAt = new DateTime(2024, 10, 24, 11, 59, 55, 965, DateTimeKind.Local).AddTicks(5009),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e8b2c347-c4b2-429c-868a-65b4006becbe",
                            CreatedAt = new DateTime(2024, 10, 24, 11, 59, 55, 882, DateTimeKind.Local).AddTicks(5891),
                            EmailConfirmed = false,
                            IsActive = true,
                            LockoutEnabled = false,
                            NormalizedUserName = "01234567410",
                            PasswordHash = "AQAAAAIAAYagAAAAEMn/CNZ/qZ7PjOaHBI5WTPQQKluxidcbpE902HhWbvxc0SRpf5Mgeer6hjTTwV+U5g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "123a6975-082f-4527-9e76-069f519b922e",
                            TwoFactorEnabled = false,
                            UpdatedAt = new DateTime(2024, 10, 24, 11, 59, 55, 882, DateTimeKind.Local).AddTicks(5892),
