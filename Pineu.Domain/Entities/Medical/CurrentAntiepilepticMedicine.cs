...
public class CurrentAntiepilepticMedicine : Entity<Guid> {
    ...
    private CurrentAntiepilepticMedicine(Guid id) : base(id) { }
    private CurrentAntiepilepticMedicine(Guid id, int? medicineId, Guid? userMedicineId, int? amount, short? dateTimeUnitTypeId,
    ...
    public static CurrentAntiepilepticMedicine Create(Guid id, int? medicineId, Guid? userMedicineId, int? amount,
